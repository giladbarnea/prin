...
#### Contract
- Categories defined in `defaults.py` must be described in `README.md`, and `fs_root` must include representative files for coverage. Any category change requires updates to all three.
