...
Before making changes: map your plan against `PARITIES.md`. Identify which elements will be affected by your changes and have a general idea of what you’ll need to update when you’re done. An element is a high‑resolution concept—ranging from a reference to a single symbol to a Member line, or, rarely, an entire set.
